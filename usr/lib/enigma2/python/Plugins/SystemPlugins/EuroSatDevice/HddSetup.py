...
def DiskEntry(model, size, removable):
	...
	if removable:
		picture = '/usr/lib/enigma2/python/Plugins/SystemPlugins/EuroSatDevice/icons/diskusb.png'
	else:
		picture = '/usr/lib/enigma2/python/Plugins/SystemPlugins/EuroSatDevice/icons/disk.png'
...
class HddSetup(Screen):
	...
	def setWindowTitle(self):
		self.setTitle(_('EuroSat Device'))
